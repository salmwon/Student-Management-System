...
function Footer() {
  return (
    <div style={{ height: '300px', backgroundColor: "terniary", }} className=' w-100 mt-5'>
      <div className="container footer-content d-flex justify-content-between">
        <div className="title w-25 mt-5">
<h6><img className='w-25' src={logo} alt="" />Student management</h6>
      ...
      <p className='text-center mt4'>Copyright &copy;2023 Student management . Build with React.</p>
    </div>
  )
}
