...
import 'animate.css'
import leavemanage from '../Student/images/leavemanage.png'
import notes from '../Student/images/notes.png'
import announce from '../Student/images/announce.png'
        ...
        <div  className='container'>
          <div className="row align-items-center mt-5 mb-5" >
            ...
            <div className="col-lg-5 animate__animated animate__backInRight">
              <img className='imgfluid w-100' src={adminhome} alt="" />
            </div>
          </div>
